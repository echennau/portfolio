...
const Landing = () => {
  return (
    <div className="flex justify-between">
      <div className="font-bold flex flex-col bg-gradient-to-r from-white via-accent brightness-110 to-secondary bg-clip-text text-transparent">
        <span className="text-9xl">Hello, </span>
        <span className="text-8xl text-accent/25">
          I&apos;m Ethan Chennault.
        </span>
        <span className="text-4xl mt-4 text-accent/25">
          Let&apos;s connect.
        </span>
      </div>
      <div className="relative flex-grow min-w-32 max-w-80 flex justify-center items-center">
        <svg
